...
def open_third_page():
    third_window = tk.Tk()
    third_window.title("Project - Kelompok 7")
    screen_width = 360
    screen_height = 640 
    third_window.geometry(f"{screen_width}x{screen_height}")
    ...
    canvas = tk.Canvas(third_window, width=screen_width, height=screen_height)
    ...
    back_button = tk.Button(third_window, text="BACK", font=("Helvetica", 14, "bold"),
